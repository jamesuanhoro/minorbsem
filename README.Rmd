...
Structural equation models (SEMs) rarely reject the null
hypothesis that there is no model misspecification.
One explanation for this problem is that covariance 
...
`minorbsem` also fits random-effects meta-analytic confirmatory factor analyses 
(CFAs) that capture the influence of minor factors,
according to the approach outlined by @uanhoro_hierarchical_2022.
