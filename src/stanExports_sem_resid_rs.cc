...
#include "stanExports_sem_resid_rs.h"

RCPP_MODULE(stan_fit4sem_resid_rs_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_sem_resid_rs")
